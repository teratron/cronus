...
| [l2-nodus-runtime.md](specifications/l2-nodus-runtime.md) | Rust crate `crates/nodus`: module structure (lexer/parser/ast/vocab/validator/executor/observability/transpiler/workflows), invariant compliance table (NL-1…NL-10, E013/E014 enforced), Value enum, executor boot sequence (6 steps), public API (scaffold/validate/run/transpile/test/run_with_provider/run_with_audit/run_with_provider_and_audit), ModelProvider + AuditProvider extension points, vocabulary schema v0.4.6 (51 commands + RUN meta-command) | Stable | 2 | 1.0.3 |
...
- **Last Updated**: 2026-06-24 (l2-nodus-observability.md added)
