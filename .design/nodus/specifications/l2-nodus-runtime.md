...
### 3.1 Invariants added after v1.0.0 — realization status [ADDED v1.3.0, EXTENDED v1.4.0]

`l1-nodus-language.md` has grown NL-11 … NL-26 through additive refinement since
