...
Tactical registry of all phases and their statuses, ordered by the growth metaphor (seed → stem → leaf → flower). Atomic checklists live in `tasks/phase-{N}.md`. Phase 7 (TUI) is now decomposed and ready to run; later phases are decomposed on entry.
...
| [Phase 7](tasks/phase-7.md) | Leaf — TUI (interactive terminal) | `In Progress` |
